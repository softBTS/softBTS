...
" BTS_PROGNAME " (version " BTS_VERSION ").\r\n\
" BTS_COPYRIGHT "\r\n\
\r\n";
...
{
	vty_out(vty, "%s %s (%s).%s", BTS_PROGNAME, BTS_VERSION,
		host.name ? host.name : "", VTY_NEWLINE);
	vty_out(vty, "%s%s", BTS_COPYRIGHT, VTY_NEWLINE);
      ...
      "Write to configuration file\n")
{
	...
	vty_out(file_vty, "!\n! SoftBTS configuration saved from vty\n!   ");
